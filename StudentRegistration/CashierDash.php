    ...
    <html>
        <head>
            ...
            <div class="information" >
                    ...
                    <form>
                        <label style="font-size: 18px; font-weight: bolder; align: center;">Unpaid Applications</label>
                        <div class="intro-table" method="POST" action="">
                            ...
                            <tbody>
                                ...
                                if(isset($_SESSION['Lusername']) )
                                {
                                    ...
                                    $sql = "SELECT ID, firstname, lastname, idnumber, gender, studyYear, paid FROM tblapplications WHERE paid = 'No'";		
