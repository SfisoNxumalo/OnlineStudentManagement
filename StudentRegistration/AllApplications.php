                               ...
                               if(isset($_SESSION['Lusername']) )
                               {
                                                   ...
                                                   <head>
                                                       ...
                                                       <div class="information" >
                                                               ...
                                                               <label style="font-size: 18px; font-weight: bolder; align: center;">Welcome $loggeduser</label>
                                                                   <label style="font-size: 18px; font-weight: bolder; align: center;">All Applications</label>
                                   ...
                                   $sql = "SELECT ID, firstname, lastname, idnumber, gender, studyYear, paid FROM tblapplications";		
